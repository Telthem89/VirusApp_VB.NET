...
Public Class QuickScan
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        ...
        If Not ProgressBar1.Value = ProgressBar1.Maximum Then
            ...
            Try
                ...
                'Dim read As String = My.Computer.FileSystem.ReadAllText("viruslist.txt").ToString
                ...
                Dim virus As FileStream = New FileStream(ListBox1.SelectedItem, FileMode.Open, FileAccess.Read, FileShare.Read, 8192)
                'shit = New FileStream(ListBox1.SelectedItem, FileMode.Open, FileAccess.Read, FileShare.Read, 8192)
                md5.ComputeHash(virus)
                virus.Close()
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        If ListBox2.Items.Count = 0 Then
            MsgBox("What hell are you doing?", MsgBoxStyle.Critical)
            Exit Sub
        End If
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        If MsgBox("Are you sure you want to abort the scan?", MsgBoxStyle.YesNo, "Zimplats there, Hello!") = MsgBoxResult.Yes Then
            Timer1.Stop()
            If ListBox2.Items.Count > 0 Then
                MsgBox("Scanning has been completed. There was" & vbCrLf & ListBox2.Items.Count & " viruses detected. Please review the list and choose an action.", MsgBoxStyle.Critical)
                Timer1.Stop()
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        If MsgBox("Are you sure you want to ignore ALL items?", MsgBoxStyle.YesNo, "Zimplats there, Hello!") = MsgBoxResult.Yes Then
            ListBox2.Items.Clear()
            ListBox2.Enabled = True
            ProgressBar1.Value = 0
            Button4.Visible = False
